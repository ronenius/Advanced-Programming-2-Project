...
function addContactElement(friend) {
    console.log(friend)
    return "<input type=\"radio\" class=\"d-block btn-check\" name=\"btnradio\" id=\""+friend.username+"\" autocomplete=\"off\">\n<label class=\"btn btn-outline-primary\" for=\""+friend.username+"\"><div class=\"row\"><div class=\"col-2\"><img src=\""+friend.picture+"\" style=\"left:0%; width:100%;\"></div><div class=\"col\">"+friend.name+"</div><div class=\"col-2\" id=\""+friend.username+"Time\"></div></div></label>\n";
}
const addContactButton = function() {
    ...
    document.getElementById("Friends").innerHTML += addContactElement(friends[friends.length-1].friend);
    input1.value = "";
    initContact();
}
